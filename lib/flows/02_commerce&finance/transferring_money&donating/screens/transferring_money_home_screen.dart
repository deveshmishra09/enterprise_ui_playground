import 'package:enterprise_ui_playground/flows/02_commerce&finance/transferring_money&donating/wedgets/choose_payment_type_bottom_sheet.dart';
import 'package:flutter/material.dart';

class TransferringHomeScreen extends StatefulWidget {
  const TransferringHomeScreen({super.key});

  @override
  State<TransferringHomeScreen> createState() => _HomeScreenState();
}

class _HomeScreenState extends State<TransferringHomeScreen> {
  @override
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  showModalBottomSheet(
                                    ...
                                    builder: (context) {
                                      return const ChoosePaymentTypeBottomSheet();
                                    },
                                  );
                                },
                                child: Column(
