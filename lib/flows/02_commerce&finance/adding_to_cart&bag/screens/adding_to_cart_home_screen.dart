import 'package:enterprise_ui_playground/flows/02_commerce&finance/adding_to_cart&bag/screens/cart_screen.dart';
...
class AddingToCartHomeScreen extends StatefulWidget {
  final Map<String, dynamic>? saleItemData;
  const AddingToCartHomeScreen({super.key, this.saleItemData});

  @override
  State<AddingToCartHomeScreen> createState() => _AddingToCartHomeScreenState();
}

class _AddingToCartHomeScreenState extends State<AddingToCartHomeScreen> {
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  child: ListTile(
                    leading: Image.asset('lib/core/mock_data/profile_images/profile_1.jpg'),
                    ...
                    onTap: () {
                      final Map<String, dynamic> saleItemData = {
                        'title': 'Adam Smith',
                        'description': 'This T-shirt is made from 100% organic cotton',
                        'price': '\$50.00',
                        'additionalImage': 'lib/core/mock_data/profile_images/profile_1.jpg',
                      };
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) =>
                              CartScreen(saleItemData: saleItemData),
                        ),
                      );
                    },
                  ),
