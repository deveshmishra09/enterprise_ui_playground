...
class AddToFavouriteScreen extends StatefulWidget {
  ...
  @override
  State<AddToFavouriteScreen> createState() => _AddToFavouriteScreenState();
}

class _AddToFavouriteScreenState extends State<AddToFavouriteScreen> {
