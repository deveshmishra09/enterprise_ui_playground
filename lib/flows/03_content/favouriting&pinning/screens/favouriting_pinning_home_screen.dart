import 'package:enterprise_ui_playground/flows/03_content/favouriting&pinning/screens/add_to_favourite_screen.dart';
import 'package:flutter/material.dart';

class FavouritingPinningHomeScreen extends StatefulWidget {
  const FavouritingPinningHomeScreen({super.key});

  @override
  State<FavouritingPinningHomeScreen> createState() => _FavouritingPinningHomeScreenState();
}

class _FavouritingPinningHomeScreenState extends State<FavouritingPinningHomeScreen> {
            ...
            child: Column(
              children: [
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Icon(
                          isFavoutireSelected ? Icons.favorite : Icons.favorite_border,
                          color: isFavoutireSelected ? Colors.red : Colors.black,
                          size: 30.0,
                        ),
                      ),
                    ),
                ...
                ? GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final imagePath = visibleFavouritedItems[index]['image']!;
                    return Container(
                      decoration: BoxDecoration(
                    ...
                    return GestureDetector(
                      onTap: () async {
                        final result = await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => AddToFavouriteScreen(
                        ...
                        if(result != null && result is Map<String, String>) {
                          final archivedCategory = result['archived_category'];
                          final archivedImage = result['archived_image'];
                          final favouriteCategory = result['favourite_category'];
                          final favouriteImage = result['favourite_image'];

                          setState(() {
                            if (archivedCategory != null && archivedImage != null) {
                              archivedItems.add({
                                'category': archivedCategory,
                                'image': archivedImage,
                              });
                            }
                            if (favouriteCategory != null && favouriteImage != null) {
